...
orderRouter.post("/orders", orderController_1.placeOrder);
orderRouter.get("/orders/:id", orderController_1.getOrderById);
orderRouter.delete("/orders/:id", orderController_1.cancelOrder);
orderRouter.use(auth_1.default);
/**
 * @swagger
 * components:
 *   schemas:
...
*/
orderRouter.get("/orders", orderController_1.getOrders);
